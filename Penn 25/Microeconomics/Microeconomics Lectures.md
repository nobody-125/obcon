...
* **Marginal revenue and marginal cost** tells if firms should increase or decrease output to increase profit:
	* MR equals the change in total revenue over the change in quantity, and MC equals the change in total cost over the change in quantity
...
* **Consumer Expenditure** is total spending on a good, $P\times Q$.
### Short vs. Long Run Operation
* **Short Run:** fixed costs are unavoidable, they've already been sunk. Even if the firm shuts down in short-run, they will still incur these fixed costs. It'll be rational to continue operating if any of the following apply:
$$
TR-TC\geq FC; TR\geq VC; P\geq AVC
$$
* **Long Run:** fixed costs can be avoided if the firm exits, and temporally, it also allows for the possibility of entry by competitors.
	* When competition increases, incumbent firm's demand decreases and becomes more elastic
...
* Increase in variable costs increases marginal costs
* Change in price does not shift the supply curve
##### Law of Supply
...
# Econ Lecture 12 (Price Controls)
### Price Controls
* Consists of price ceilings and price floors: regulations that determine the minimum/maximum price of a service or good provided
* **Effective** only when set below or above the equilibrium price respectively
...
* Q. Supply equation
* Q. Demand equation
Substitute price floor/ceiling for the price in the supp/demand equations. Disequilibrium is the difference between these two final values.
# Econ Lecture 13 (Introduction to Taxation, 2025-10-20)
### Midterm topics:
* Seller choice
* Price controls
* Taxes and subsidies
...
* Generally, **the more inelastic party bears the greater burden of the tax**
	* *When supply is more elastic, sellers experience less of the burden of the tax*
	* *When demand is more elastic, buyers experience less burden*

> [!NOTE]
> A per-unit tax creates the same price wedge no matter whether it is imposed on the buyer or the seller. This means that regardless of who the tax is put on, the [[Deadweight Loss (DWL)]] is always the same.

##### Effects
* When consumers bear legal incidence, demand curve shifts down vertically by per-unit tax, when producers bear legal incidence, supply curve shifts upward vertically by per-unit tax
* Elasticity ultimately determine not just burden, but also DWL: Less elastic supply-demand leads to smaller DWL and larger revenue, more elastic supply-demand leads to large DWL, less revenue
* What this really means: Less elasticity means **more efficiency,** greater elasticity means **less efficiency**
	* **Philly Soda Tax:** Anticipated revenue of $46 million from the tax, but the result was closer to $39.3 million, illustrating an improper projection of elasticity (demand was more elastic than it actually was).
	* Soda tax decreased soda consumption in the city, but rose outside Philly, since agents can simply drive to the Philadelphia metro (e.g., Levittown) and buy soda at a cheaper price as a substitute to soda in the city
### Subsidy
...
* Since the consumers are subsidized by the government, you still pay less, despite this higher price, and since the price is higher, the seller receives more money.
##### Comparison to Tax on Sellers
* A tax imposed on sellers shifts the seller supply curve left/up
...
II. Buyers will benefit more from the subsidy than sellers  
III. There will be a deadweight loss
