...
##### History
- 1895: The Sugar Trust (American Sugar Refining Co)
- 1905: Meat Packing (Swift & Co)
- 1911: The Oil Trust (Standard Oil and John D. Rockefeller)
- Interstate Commerce (1887) Sherman (1890)/Clayton + FTC (1914) Acts: First implementations of antitrust law in the US, however, even to this day, there is no consistent code or "rulebook" on trusts.
### Critiques and Perspectives
##### Progressive View
The progressive criticism of trust is that they are bad for small business. The most obvious example in big tech, for instance, which has been discussed in utilitarianism and liberalism, is NETFLIX, their main rival having been Blockbuster at the time, when they entered the market, they had innovated a method that significantly reduced costs and labor. Whereas Blockbuster required consumers to borrow-and-return to a brick & mortar location, Netflix would begin as a mailing service, entailing the displacement of competitors. When Netflix and other services like Hulu transitioned to streaming, it would also appear that the broader communications industry was disrupted as well, with optical disc manufacturers, CD stores and others in the industry likely being a loser in this situation.

Brandeis lies on the polarized side of the spectrum, favoring smaller firms and anti-monopoly tradition. The most famous case is A&P who took advantage of economies of scale to provide groceries to consumers, particularly during the depression, at a cheaper price. Brandeis would try to disrupt this environment and desired a progressive tax on multi-store grocers that would have completely destroyed them.
##### Efficiency Thesis (F.A. Hayek, Friedman)
Perspective that merger and integration create no inefficiency at all
### Monopoly
...
# 02 Week of 2026-01-26
## Lecture 03
##### Review: Intellectual Property
Open source and GPL, distinct from public domain but eases the dissemination of such information.
- Origins in early personal computer history when US government filed antitrust lawsuit against IBM from 1969 to 1982, believing that their entry into the minicomputer and personal computer market was anti-competitive. 
- IBM would sell computers with bundled software pre-installed (sound familiar?) and this was initially considered to be anti-competitive.
- Believed that open source would be too difficult to monetize, however, examples like Android and Linux have shown that the standardization of free software has conferred immense profits upon companies like Google (higher market share globally compared to iOS)
### Facebook Decision
- Market definition: Social networks that are intended to link friends and family, which excludes platforms like TikTok, X (formerly known as Twitter), Reddit, etc.
	- How did the Trade Commission reach this definition? They searched for physical attributes that a group of firms have in common. 
	- Substitution data: Ability for users to substitute between Facebook and other services (e.g., TikTok or YouTube). Used by both defendant and Court
- Market share: Defined by number of daily average users or monthly average users
- Basis for cases:
	- Sherman Act Standard (1890): Does the company have a dominant market share?
	- Clayton Act Standard (1914): Does the company's actions tend to lessening competition or work towards creating a monopoly? (Remains salient in cases where a body has much lower market share)
...
- Identified the existence of markets and submarkets, rather than identifying a specific grouping of products or sales capable of being monopolized
- Reasonable interchangeability: "Square factory"-esque problem where the defined market can possess a broad definition.
