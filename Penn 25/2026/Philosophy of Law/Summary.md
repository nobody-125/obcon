...
- For one, a **plea** is used in a situation where the speaker is at the mercy of another individual who has the power to release him. 
- The opposite situation would be more akin to an **order,** in which the speaker likely has the ability to secure compliance with his expressed wish (with a threat). 

Commands within the imperative theory of law would appear to bear a closer resemblance to orders; they are an expression of a desire that someone else do something (or refrain from doing it), backed by a threat to impose some sanction upon that person should they do it. Like Hobbes, Austin posits the existence of a sovereign to enforce these commands, but radically reduces it to the principles that:

- The entity is habitually obeyed by those it commands.
- It does not habitually obey anyone else.
##### Caveats
The orders that are issued must be generalized, more so a set of rules that are to be followed rather than individual instructions with no long-term temporal consistency. Individuals must expect and believe that disobedience will lead to sanctions that are preferably avoided. If this is a truism, then it is the case that there will be general compliance with the orders.
